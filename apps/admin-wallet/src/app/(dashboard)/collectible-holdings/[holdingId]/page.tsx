      ...
      <h1 className="mb-4 text-xl font-bold">カード保有詳細</h1>
        ...
        <section className="mb-6 flex gap-4 rounded-lg border border-sengoku-border bg-sengoku-navy p-4">
          ...
          <div className="text-sm">
            ...
            <p className="text-xs text-sengoku-muted">asset_code: {holding.asset.assetCode}</p>
            {holding.asset.rarity && <p className="text-xs text-sengoku-muted">レアリティ: {holding.asset.rarity}</p>}
          </div>
        </section>
