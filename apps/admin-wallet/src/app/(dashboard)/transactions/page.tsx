...
export default function TransactionsPage() {
  ...
  return (
    <>
        ...
        <div className="mb-4 flex flex-wrap items-end gap-3 rounded-lg border border-sengoku-border bg-sengoku-navy p-3">
          ...
          <label className="text-xs">
            ...
            <select
              ...
              className="mt-1 block w-36 rounded-md border border-sengoku-border px-2 py-1 text-sm"
            >
          ...
          <button onClick={load} className="rounded-md bg-sengoku-gold px-4 py-1.5 text-sm text-sengoku-navy-deep">
            検索
          </button>
        </div>
