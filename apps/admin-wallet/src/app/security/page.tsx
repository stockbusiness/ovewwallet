          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <span
              className={`rounded-full px-3 py-1 text-xs font-bold ${
                me.mfaEnabled ? "bg-emerald-100 text-emerald-700" : "bg-neutral-100 text-neutral-500"
              }`}
            >
              {me.mfaEnabled ? "有効" : "無効"}
            </span>
          ...
          {!me.mfaEnabled && setupData && (
            <form onSubmit={confirmEnable} className="flex flex-col gap-3">
              ...
              <div className="rounded-md bg-neutral-50 p-3 text-xs">
                <p className="mb-1 text-neutral-500">シークレットキー</p>
                <p className="break-all font-mono text-sm font-bold">{setupData.secret}</p>
              </div>
              <div className="rounded-md bg-neutral-50 p-3 text-xs">
                <p className="mb-1 text-neutral-500">登録用URL</p>
