 ...
 */
@Module({
  providers: [IntegrationHttpClient, IntegrationConfigProvider, CommonUserHubAdapter, AgencyReferralAdapter],
  exports: [IntegrationHttpClient, IntegrationConfigProvider, CommonUserHubAdapter, AgencyReferralAdapter],
})
